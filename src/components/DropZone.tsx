  ...
  return (
    <div className="w-full">
      <div
        ...
        className={`relative border-2 border-dashed rounded-2xl p-5 py-7 sm:p-12 text-center cursor-pointer transition-all duration-200 ${
          isDragOver
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:gap-4">
          <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center transition-transform ${
          ...
          <div>
            <h3 className="text-sm sm:text-lg font-bold text-slate-800 dark:text-slate-200">
              {busy ? 'Inspecting JW Library Backups...' : 'Drop your .jwlibrary backup files here'}
            </h3>
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1 max-w-md mx-auto px-2">
              Select 2 or more backups to merge (e.g. from your iPad, iPhone, and PC).
            </p>
          </div>

          <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-medium text-slate-600 dark:text-slate-400 max-w-full">
            <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-slate-100 dark:bg-slate-800/80 flex items-center gap-1 flex-shrink-0">
              <FileArchive className="w-3 h-3 text-theocratic-500" /> .jwlibrary
            </span>
            <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-slate-100 dark:bg-slate-800/80 flex-shrink-0">
              Multi-device
            </span>
            <span className="px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full bg-emerald-100/70 text-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-300 flex-shrink-0">
              Client-Side
            </span>
          </div>
        </div>
